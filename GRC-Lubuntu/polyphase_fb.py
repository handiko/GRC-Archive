...
# Title: Polyphase Fb
# Generated: Tue Apr 17 17:53:24 2018
##################################################
...
class polyphase_fb(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.pfb_channelizer_ccf_0, 6), (self.qtgui_freq_sink_x_0_0, 6))    
...
def main(top_block_cls=polyphase_fb, options=None):
