...
# Title: Psk Analysis
# Description: QPSK
# Generated: Fri Apr 13 10:50:55 2018
##################################################
...
class psk_analysis(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Psk Analysis")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Psk Analysis")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "psk_analysis")
        self.restoreGeometry(self.settings.value("geometry").toByteArray())

        ##################################################
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 2.4e6 / 32
        self.gmu = gmu = 0.0025
        self.baudrate = baudrate = 4800
        ...
        self.tab_layout_1.addWidget(self._qtgui_waterfall_sink_x_0_0_win)
        ...
        self.digital_clock_recovery_mm_xx_0 = digital.clock_recovery_mm_cc(4*(1+0.0), 0.25*gmu*gmu, 0.5, gmu, 0.0026)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate,True)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/handiko/gqrx_20180412_112520_137224800_75000_fc.raw', True)
    ...
    def set_baudrate(self, baudrate):
        ...
        self.qtgui_waterfall_sink_x_0_0.set_frequency_range(0, self.baudrate*4)
        self.qtgui_freq_sink_x_0_0.set_frequency_range(0, self.baudrate*4)


def main(top_block_cls=psk_analysis, options=None):
