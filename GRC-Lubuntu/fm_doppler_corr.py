...
# Title: Fm Doppler Corr
# Generated: Fri Apr 20 09:19:34 2018
##################################################
...
from feed_forward_doppler_corr import feed_forward_doppler_corr  # grc-generated hier_block
...
class fm_doppler_corr(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Fm Doppler Corr")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Fm Doppler Corr")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "fm_doppler_corr")
        ...
        self.doppler_shift = doppler_shift = 0.0
        self.doppler_bw = doppler_bw = 50e3
        ...
        self._doppler_shift_range = Range(-doppler_bw*0.5, doppler_bw*0.5, 1.0, 0.0, 200)
        self._doppler_shift_win = RangeWidget(self._doppler_shift_range, self.set_doppler_shift, "doppler_shift", "counter_slider", float)
        ...
        self.qtgui_time_sink_x_0.set_y_axis(-50e3, 50e3)
        ...
        self.tab_grid_layout_1.addWidget(self._qtgui_time_sink_x_0_win, 1,0,1,1)
        ...
        self.qtgui_freq_sink_x_1_0_0.set_y_axis(-100, 0)
        ...
        self.tab_grid_layout_2.addWidget(self._qtgui_freq_sink_x_1_0_0_win, 1,0,1,1)
        ...
        self.tab_grid_layout_2.addWidget(self._qtgui_freq_sink_x_1_0_win, 0,0,1,1)
        ...
        self.feed_forward_doppler_corr_0 = feed_forward_doppler_corr(
            corr_gain=1,
            doppler_bw=doppler_bw*1.25,
            integration_sample=50000,
            samp_rate=samp_rate,
        )
        ...
        self.blocks_vco_c_0 = blocks.vco_c(samp_rate, 2*math.pi*2.5e3, 1.0)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate,True)
        self.blocks_rotator_cc_0 = blocks.rotator_cc((doppler_shift/samp_rate)*2*math.pi)
        ...
        self.connect((self.blocks_rotator_cc_0, 0), (self.channels_channel_model_0, 0))    
        self.connect((self.blocks_throttle_0, 0), (self.feed_forward_doppler_corr_0, 0))    
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_freq_sink_x_0, 0))    
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_waterfall_sink_x_0, 0))    
        self.connect((self.blocks_vco_c_0, 0), (self.blocks_rotator_cc_0, 0))    
        self.connect((self.channels_channel_model_0, 0), (self.blocks_throttle_0, 0))    
        self.connect((self.feed_forward_doppler_corr_0, 1), (self.qtgui_freq_sink_x_1, 0))    
        self.connect((self.feed_forward_doppler_corr_0, 2), (self.qtgui_freq_sink_x_1_0, 0))    
        self.connect((self.feed_forward_doppler_corr_0, 0), (self.qtgui_freq_sink_x_1_0_0, 0))    
        self.connect((self.feed_forward_doppler_corr_0, 3), (self.qtgui_time_sink_x_0, 0))    
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.feed_forward_doppler_corr_0.set_samp_rate(self.samp_rate)
        self.blocks_throttle_0.set_sample_rate(self.samp_rate)
        self.blocks_rotator_cc_0.set_phase_inc((self.doppler_shift/self.samp_rate)*2*math.pi)
    ...
    def get_doppler_bw(self):
        return self.doppler_bw

    def set_doppler_bw(self, doppler_bw):
        self.doppler_bw = doppler_bw
        self.feed_forward_doppler_corr_0.set_doppler_bw(self.doppler_bw*1.25)


def main(top_block_cls=fm_doppler_corr, options=None):
