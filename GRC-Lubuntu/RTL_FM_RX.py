...
# Title: RTL SDR FM RX
# Generated: Wed Sep 19 00:55:11 2018
##################################################
...
class RTL_FM_RX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.fft_filter_xxx_0 = filter.fft_filter_fff(1, (firdes.low_pass(pow(10.0,afgain/10.0),ch_rate,12e3,6e3,firdes.WIN_BLACKMAN)), 1)
        ...
        self.connect((self.fft_filter_xxx_0, 0), (self.blocks_keep_one_in_n_0, 0))    
    ...
    def set_ch_rate(self, ch_rate):
        ...
        self.fft_filter_xxx_0.set_taps((firdes.low_pass(pow(10.0,self.afgain/10.0),self.ch_rate,12e3,6e3,firdes.WIN_BLACKMAN)))
